...
<footer>
    <div class="container">
        ...
        <div class="social-links">
            <a href="https://tiktok.com/@r_tyy7" target="_blank" class="tiktok-link"><i class="fab fa-tiktok"></i> TikTok</a>
            <a href="https://t.me/cvbnm_6" target="_blank" class="telegram-link"><i class="fab fa-telegram"></i> Telegram</a>
        </div>
        <br>
